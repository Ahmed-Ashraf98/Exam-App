export class AuthEndpoint {
  ...
  static DELETE_MY_ACC = `https://exam.elevateegy.com/api/v1/auth/deleteMe`;
  ...
  static PROFILE_INFO = `https://exam.elevateegy.com/api/v1/auth/profileData`;
  static FORGOT_PASSWORD = `https://exam.elevateegy.com/api/v1/auth/forgotPassword`;
